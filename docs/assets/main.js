                ...
                (t.Index.prototype.query = function (e) {
                    ...
                    for (var u = 0; u < r.clauses.length; u++) {
                        var l = r.clauses[u],
                            ...
                            p = t.Set.empty;
                        l.usePipeline
                            ? (h = this.pipeline.runString(l.term, {
                                  fields: l.fields,
                              }))
                            : (h = [l.term]);
                        ...
                        for (var o = 0; o < s.length; o++) {
                            ...
                            for (var l = 0; l < u.length; l++) {
                                ...
                                this.metadata[i][a][h] == null
                                    ? (this.metadata[i][a][h] =
                                          e.metadata[i][a][h])
                                    : (this.metadata[i][a][h] = this.metadata[
                                          i
                                      ][a][h].concat(e.metadata[i][a][h]));
                            }
                        }
                    }
                }),
    ...
    function He(t, e, r, n) {
        ...
        for (let o = 0, a = Math.min(10, s.length); o < a; o++) {
            let u = n.data.rows[Number(s[o].ref)],
                l = ve(u.name, i);
            u.parent &&
                (l = `<span class="parent">${ve(u.parent, i)}.</span>${l}`);
        ...
        Z = class extends k {
            ...
            createGroups() {
                ...
                for (let i = 0; i < r.length; i++)
                    this.groups.push(new oe(r[i], n[i]));
            }
            onClick(r) {
